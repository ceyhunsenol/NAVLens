"""Historical-mean implementation of the shared estimator boundary."""
...
class HistoricalMeanBaseline:
    ...
    def fit_predict(self, history: pd.Series) -> FittedPrediction:
        ...
        clean_returns = validated_decimal_returns(history, minimum_size=self.initial_training_size)
        ...
        prediction = build_naive_prediction(
            expected_return, residuals, self.confidence_level, model
        )
