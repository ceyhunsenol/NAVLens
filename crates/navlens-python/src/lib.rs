...
use currency_pair::PyCurrencyPair;
...
use fx_rate_series::PyFxRateSeries;
use holding_position::PyHoldingPosition;
use market_calendar::PyMarketCalendar;
...
use session_kind::PySessionKind;
use session_override::PySessionOverride;
...
fn _native(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_class::<PyCurrencyPair>()?;
    module.add_class::<PyFxRate>()?;
    module.add_class::<PyFxRateKind>()?;
    module.add_class::<PyFxRateObservation>()?;
    module.add_class::<PyFxRateSeries>()?;
    module.add_class::<PyPriceAdjustment>()?;
    module.add_class::<PyMarketDate>()?;
    module.add_class::<PySessionKind>()?;
    module.add_class::<PySessionOverride>()?;
    module.add_class::<PyMarketCalendar>()?;
